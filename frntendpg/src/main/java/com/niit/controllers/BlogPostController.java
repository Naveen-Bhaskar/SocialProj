...
addBlogPost(@RequestBody BlogPost blogPost, HttpSession session) {
...
ErrorClas ErrorClas = new ErrorClas(6, "Unable to post blogpsoe.." + e.getMessage());
...
ErrorClas ErrorClas=new ErrorClas(6,"Access Denied....");
return new ResponseEntity<ErrorClas>(ErrorClas,HttpStatus.UNAUTHORIZED);
}
